...
// ===================================
const SHIRT_COLORS = [
  { id: "white",  name: "White",  hex: "#FFFFFF", group: "Essentials" },
  { id: "black",  name: "Black",  hex: "#000000", group: "Essentials" },
  { id: "grey",   name: "Grey",   hex: "#9E9E9E", group: "Essentials" },
  { id: "red",    name: "Red",    hex: "#CC2222", group: "Bold & Vibrant" },
  { id: "blue",   name: "Blue",   hex: "#2244BB", group: "Bold & Vibrant" },
  ...
  { id: "pink",   name: "Pink",   hex: "#FF6FAE", group: "Bold & Vibrant" },
  { id: "purple", name: "Purple", hex: "#6B2DB5", group: "Bold & Vibrant" },
  { id: "navy",   name: "Navy",   hex: "#0A1A3A", group: "Dark & Rich"    },
];
...
const SHIRT_SIZES = [
  ...
  { id: "XXL", label: "XXL", desc: "2X-Large" },
];
...
const state = {
  ...
  selectedSize:   SHIRT_SIZES[4],   // default: XL
  openProduct:    null,
};
...
const renderSizeSelector = (product) => {
  ...
  const savedLabels = Array.isArray(product.sizes) && product.sizes.length
    ? product.sizes : SHIRT_SIZES.map(s => s.label);
